<x-layout title="Home 1">
    <div class="w-screen h-screen grid grid-cols-2">
        <div class="w-full h-full grid content-center bg bg-[#72A9D7]">
            ...
            <a href="login" class="mx-auto border-2 font-sans border-white bg bg-[#72A9D7] text-center  w-40 py-2 rounded-full mt-4 text-white hover:bg-[#5891bf] focus:border-gray-600">Iniciar sesión</a>
        </div>
