...
@endif
        <div class="grid place-content-center place-items-center mx-auto bg-gray-100 my-auto p-4">
            ...
            <h1 class="text-xl  font-bold">Patient {{ Auth::user()->userable->caretaker ? 'and caretaker' : '' }}</h1>
        </div>
        <div class="border-t border-azulnegro grid grid-cols-2 w-full p-6 bg-gray-200">
            <div class="border border-2 border-gray-200 w-[50%] mx-auto p-4 bg-gray-200">
            ...
            <div class="border border-2 dorder-gray-200 w-[50%] mx-auto p-4 bg-gray-200">
                ...
                <h1 class="text-sm">Is a caretaker</h1>
                <p class="text-blue-600">{{ Auth::user()->userable->caretaker ? 'Yes' : 'No' }}</p>

            </div>
            <div class="border border-2 dorder-gray-200 w-[50%] mx-auto p-4 mt-4 bg-gray-200">
                <h1 class="mb-4">Public information</h1>
                <h1 class="text-sm">Personal address</h1>
                <p class="mb-2 text-blue-600">{{ Auth::user()->userable->address}}</p>
                <h1 class="text-sm">Age</h1>
                <p class="text-blue-600">{{ Auth::user()->edad}}</p>
