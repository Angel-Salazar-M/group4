    ...
    <div class="grid grid-cols-2 h-[calc(100vh-95px)] place-content-center">
        ...
        <div class="flex flex-col justify-center items-center h-96 w-80 mx-auto">
            ...
            <div class="flex space-x-5">
                <a href="/register"
                    class="border-2 mt-6 font-sans font-semibold border-white bg bg-[#B394BD] text-center  w-52 h-12 py-2 rounded-lg text-white hover:bg-[#a885b4] focus:border-gray-600">
                    Editar perfil</a>
            </div>
        </div>
        ...
        <div class="grid grid-cols-2">
            <div class="col-span-2 flex space-x-5 justify-items-center items-center">
                ...
                <h1 class="font-sans text-2xl font-bold">Juan Gabriel Méndez</h1>
            </div>
            <div class="flex space-x-5 justify-items-center">
                ...
                <h1 class="font-sans">43-Agosto-20067</h1>
            </div>
            <div class="flex space-x-5 justify-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                    fill="#000000">
                ...
                <h1 class="font-sans">1234-1234</h1>
            </div>
            <div class="flex space-x-5 justify-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                    fill="#000000">
                ...
                <h1 class="font-sans">123456789-9</h1>
            </div>
            <div class="flex space-x-5 justify-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                    fill="#000000">
                ...
                <h1 class="font-sans">juangabriel@gmail.com</h1>
            </div>
            <div class="flex space-x-5 justify-items-center col-span-2">
                ...
                <h1>casa numero 45904 en un lugar de multiplaza</h1>
            </div>
        </div>
    </div>
</x-layout>
