    ...
    <div class="grid grid-cols-2 h-[calc(100vh-95px)] place-content-center">
        ...
        <div class="grid grid-cols-2">
            ...
            <div class="flex space-x-5 justify-items-center">
                ...
                <x-h1 class="font-sans">43-Agosto-20067</x-h1>
            </div>
            <div class="flex space-x-5 justify-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                    fill="#000000">
                ...
                <x-h1 class="font-sans">1234-1234</x-h1>
            </div>
            <div class="flex space-x-5 justify-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                    fill="#000000">
                ...
                <x-h1 class="font-sans">123456789-9</x-h1>
            </div>
            <div class="flex space-x-5 justify-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                    fill="#000000">
                ...
                <x-h1 class="font-sans">juangabriel@gmail.com</x-h1>
            </div>
