<x-layout title="Perfil">
    ...
    <div
        ...
        <div
            class="py-8 px-8 flex flex-col justify-center items-center border-4 rounded-lg border-scriptmorado h-96 w-80 mx-auto shadow-xl bg-gray-100">
        ...
        <div class="grid grid-cols-2 my-auto space-y-6 px-12">
            <div class="col-span-2 flex space-x-5 justify-items-center items-center">
                ...
                <h1 class=" text-2xl">Nombre: <input type="text" name="name"
                        class="border-scriptmorado border-2 rounded-xl py-2 px-2"></h1>
            </div>
            <div class="flex space-x-5 justify-items-center">
                ...
                <h1 class="">Fecha de nacimiento: <input type="date"
                        class="border-scriptmorado border-2 rounded-xl py-2 px-2"></h1>
            </div>
            <div class="flex space-x-5 justify-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                ...
                <h1 class="">Número de teléfono: <input type="number"
                        class="border-scriptmorado border-2 rounded-xl py-2 px-2"></h1>
            </div>
            <div class="flex space-x-5 justify-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                ...
                <h1 class="">DUI: <input type="number" class="border-scriptmorado border-2 rounded-xl py-2 px-2">
                </h1>
            </div>
            <div class="flex space-x-5 justify-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                ...
                <h1 class="">Correo electrónico: <input type="email"
                        class="border-scriptmorado border-2 rounded-xl py-2 px-2"></h1>
            </div>
            <div class="flex space-x-5 justify-items-center col-span-2">
                ...
                <h1>Dirección de clínica: <input type="text"
                        class="border-scriptmorado border-2 rounded-xl py-2 px-2"></h1>
            </div>
            <div class="flex justify-center col-span-2">
                <a href="#citasMedicas"
                    class="border-2  font-semibold border-white bg bg-scriptmorado text-center  w-40 h-12 py-2 rounded-full text-white focus:border-gray-600">
                    Guardar cambios</a>
            </div>
        </div>
    </div>
    <div class="bg-scriptmorado text-white space-x-8 h-20 flex justify-around items-center mt-20 col-span-2 w-full">
