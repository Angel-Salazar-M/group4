        ...
        @foreach ($patients as $patient)
            <div
                ...
                <div class="flex mb-2 transition-all ease-in-out space-x-2"> <svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <p class="text-gray-600"> {{ $patient->user->birthday }} </p>
                </div>
                <div class="flex mb-2 space-x-2 transition-all ease-in-out"><svg xmlns="http://www.w3.org/2000/svg"
                        height="24px" viewBox="0 -960 960 960" width="24px" fill="#000000">
                        <path
                    ...
                    <p class="text-[16px] ms-5 text-gray-600"> {{ $patient->user->phoneNumber }} </p>
                </div>
                <div class="flex mb-2 space-x-2 transition-all ease-in-out"><svg xmlns="http://www.w3.org/2000/svg"
                        height="24px" viewBox="0 -960 960 960" width="24px" fill="#000000">
                        <path
                ...
                <div class="flex items-center justify-center gap-x-4 mt-4">
                    <a active="false" href="/doctor/record/{{ $patient->id }}">
                        <button class="transition duration-150 ease-in-out border-2 border-scriptverde hover:-translate-y-0.5 hover:scale-110 hover:bg-scriptverde tracking-widest py-2 px-4 rounded-3xl text-xs uppercase">
                            Historial médico
                        </button>
                    </a>

                    <a href="/doctor/prescription/new">
                        <button type="button" class="inline-flex items-center bg-white text-xs uppercase tracking-widest shadow-sm focus:outline-none font-comfortaa focus:ring-2 focus:ring-scriptazul focus:ring-offset-2 disabled:opacity-25 transition ease-in-out duration-150 border-2 border-scriptazul hover:-translate-y-0.5 hover:scale-110 hover:bg-scriptazul py-2 px-4 rounded-3xl">
                            Nueva Prescripción
                        </button>
                    </a>
                </div>
