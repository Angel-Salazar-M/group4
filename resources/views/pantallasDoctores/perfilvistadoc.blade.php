...
<div class="py-8 px-8 grid grid-cols-2 h-[calc(90vh-95px)] place-content-center bg-white shadow-md max-w-7xl mt-10 mx-auto rounded-lg">
    ...
    <div class="py-8 px-8 flex flex-col justify-center items-center border-4 rounded-lg border-[#B394BD] h-96 w-80 mx-auto shadow-xl bg-gray-100">
        <img src="{{ asset('https://simg.nicepng.com/png/small/933-9332131_profile-picture-default-png.png') }}"
            class="w-36 h-36 rounded-full object-cover">
        <h1 class="mt-6  font-bold text-xl"> Dr. {{ Auth::user()->name }} </h1>
    ...
    <div class="grid grid-cols-2 my-auto space-y-6">
        <div class="col-span-2 flex space-x-5 justify-items-center items-center">
            ...
            <h1 class=" text-2xl">Nombre: {{ Auth::user()->name }} </h1>
        </div>
        <div class="flex space-x-5 justify-items-center">
            ...
            <h1 class="">Fecha de nacimiento: {{ Auth::user()->birthday }} </h1>
        </div>
        <div class="flex space-x-5 justify-items-center">
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                fill="#000000">
            ...
            <h1 class="">Número de teléfono: {{ Auth::user()->phoneNumber }} </h1>
        </div>
        <div class="flex space-x-5 justify-items-center">
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                fill="#000000">
        ...
        <div class="flex space-x-5 justify-items-center">
            ...
            <h1 class="">Correo electrónico: {{ Auth::user()->email }} </h1>
        </div>
        <div class="flex space-x-5 justify-items-center col-span-2">
            ...
            <h1>Dirección de clínica: {{ Auth::user()->place_address }} </h1>
        </div>
