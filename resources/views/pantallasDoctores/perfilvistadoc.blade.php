<x-layout title="expediente">
    ...
    <div class="grid-cols-2 h-[calc(100vh-115px)] flex">

        <div class="flex flex-col justify-center items-center h-96 w-80 mx-auto border-4 border-[#B394BD] rounded-lg mt-20">
        ...
        <div class="grid grid-cols-2 mt-20 h-72">
            <div class="col-span-2 flex space-x-5 justify-items-center items-center">
                ...
                <h1 class="font-sans text-2xl font-bold">Nombre: Juan Gabriel Méndez</h1>
            </div>
            <div class="flex space-x-5 justify-items-center">
                ...
                <x-h1 class="font-sans">Licencia de doctor: 10290312839121</x-h1>
            </div>
            <div class="flex space-x-5 justify-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                    fill="#000000">
                ...
                <x-h1 class="font-sans">Número telefónico: 1234-1234</x-h1>
            </div>
            <div class="flex space-x-5 justify-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                    fill="#000000">
                ...
                <x-h1 class="font-sans">DUI: 123456789-9</x-h1>
            </div>
            <div class="flex space-x-5 justify-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                    fill="#000000">
                ...
                <x-h1 class="font-sans">Correo electrónico: juangabriel@gmail.com</x-h1>
            </div>
            <div class="flex space-x-5 justify-items-center col-star-1 col-span-2">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                    fill="#000000">
                    <path
                        d="M160-160q-33 0-56.5-23.5T80-240v-480q0-33 23.5-56.5T160-800h640q33 0 56.5 23.5T880-720v480q0 33-23.5 56.5T800-160H160Zm320-280L160-640v400h640v-400L480-440Zm0-80 320-200H160l320 200ZM160-640v-80 480-400Z" />
                </svg>
                <x-h1 class="font-sans">Dirección de trabajo: algun lugar del polo norte</x-h1>
            </div>
        </div>
    </div>
    <x-barrafinal/>
