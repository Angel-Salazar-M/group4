...
<div class="py-8 px-8 grid grid-cols-2 h-[calc(90vh-95px)] place-content-center bg-white shadow-md max-w-7xl mt-10 mx-auto rounded-lg">
    ...
    <div class="py-8 px-8 flex flex-col justify-center items-center border-4 rounded-lg border-[#B394BD] h-96 w-80 mx-auto shadow-xl bg-gray-100">
        <img src="{{ asset('https://karlacsphotography.com/wp-content/uploads/2021/09/MG_2664-1024x585.jpg') }}"
    ...
    <div class="grid grid-cols-2 my-auto space-y-6">
        ...
        <div class="flex space-x-5 justify-items-center">
            ...
            <h1 class="">Fecha de nacimiento: 26/09/85</h1>
        </div>
        <div class="flex space-x-5 justify-items-center">
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                fill="#000000">
            ...
            <h1 class="">Número de teléfono: 1234-1234</h1>
        </div>
        <div class="flex space-x-5 justify-items-center">
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                fill="#000000">
        ...
        <div class="flex space-x-5 justify-items-center">
            ...
            <h1 class="">Correo electrónico: Danielguzman@gmail.com</h1>
        </div>
