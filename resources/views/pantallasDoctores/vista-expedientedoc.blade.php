<x-layout title="expediente">
    ...
    <div class=>
        ...
        <div
            ...
            <div class="bg-[#B394BD] text-white space-x-8 h-20 flex justify-around items-center mt-10 col-span-2">
    ...
    <div>
        <hr class="bg-[#B394BD] h-1 rounded-full  mx-auto my-5 w-3/6 mt-16 mb-10">
    </div>
