    ...
    <div class="grid grid-cols-2 h-[calc(100vh-95px)] place-content-center">
        ...
        <div class="grid grid-cols-2">
            <div class="col-span-2 flex space-x-5 justify-items-center items-center">
                ...
                <h1 class="font-sans text-2xl font-bold">{{ $patient->user->name }}</h1>
            </div>
            <div class="flex space-x-5 justify-items-center">
                ...
                <x-h1 class="font-sans">{{ $patient->user->birthday }}</x-h1>
            </div>
            <div class="flex space-x-5 justify-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                    fill="#000000">
                ...
                <x-h1 class="font-sans">{{ $patient->user->phoneNumber }}</x-h1>
            </div>
            <div class="flex space-x-5 justify-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                    fill="#000000">
                ...
                <x-h1 class="font-sans">{{ $patient->user->dui }}</x-h1>
            </div>
            <div class="flex space-x-5 justify-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                    fill="#000000">
                ...
                <x-h1 class="font-sans">{{ $patient->user->email }}</x-h1>
            </div>
    ...
    <div class="">
        ...
        <div class="grid grid-cols-2 space-x-5 space-y-10 mb-5 place-items-center">
            ...
            <div class="col-span-2 flex space-x-5 justify-items-center items-center ml-5 col-start-1">
                ...
                <x-h1>Nombre completo: {{ $patient->user->name }}</x-h1>
            </div>
            <div class="flex space-x-5 justify-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                    fill="#000000">
                ...
                <x-h1 class="font-sans">Fecha de nacimiento: {{ $patient->user->birthday }}</x-h1>
            </div>
            <div class="flex space-x-5 justify-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                    fill="#000000">
                ...
                <x-h1 class="font-sans">Número de teléfono: {{ $patient->user->phoneNumber }}</x-h1>
            </div>
            <div class="flex space-x-5 justify-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                    fill="#000000">
                ...
                <x-h1 class="font-sans">DUI: {{ $patient->user->dui }}</x-h1>
            </div>
            <div class="flex space-x-5 justify-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                    fill="#000000">
                ...
                <x-h1 class="font-sans">Correo electrónico: {{ $patient->user->email }}</x-h1>
            </div>
            <div class="flex space-x-5 justify-items-center col-span-2">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                    fill="#000000">
