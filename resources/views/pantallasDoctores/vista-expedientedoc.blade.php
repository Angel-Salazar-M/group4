<x-layout title="expediente">
    ...
    <div
        ...
        <div class="flex flex-col justify-center items-center border-4 rounded-lg border-cafe h-96 w-80 mx-auto">
            ...
            <h1 class="text-xl  font-bold">Medical record</h1>
        </div>
        ...
        <div class="grid grid-cols-2 my-auto space-y-6">
            <div class="col-span-2 flex space-x-5 justify-items-center items-center">
                ...
                <h1 class=" text-2xl">Name: {{ $patient->name }} </h1>
            </div>
            <div class="flex space-x-5 justify-items-center">
                ...
                <h1 class="">Birth date: {{ $patient->birthday }}</h1>
            </div>
            <div class="flex space-x-5 justify-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                    fill="#000000">
                ...
                <h1 class="">Phone number: {{ $patient->phoneNumber }}</h1>
            </div>
            <div class="flex space-x-5 justify-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                    fill="#000000">
                ...
                <h1 class="">Personal ID: {{ $patient->dui }}</h1>
            </div>
            <div class="flex space-x-5 justify-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                    fill="#000000">
                ...
                <h1 class="">E-mail: {{ $patient->email }}</h1>
            </div>
            <div class="flex space-x-5 justify-items-center col-span-2">
                ...
                <h1>Home address: {{ $patient->address }}</h1>
            </div>
    ...
    <div>
        <hr class="bg-azulnegro h-1 rounded-full  mx-auto my-5 w-3/6 mb-10 mt-20">
    </div>
    <div>
        <h1 class=" text-2xl font-bold text-center col-span-2 mt-5 mb-16">MOST RECENT PRESCRIPTION</h1>
    </div>
    <div>
        <x-prescription/>
    </div>
    ...
    <div>
        <hr class="bg-azulnegro h-1 rounded-full  mx-auto my-5 w-3/6 mt-16 mb-10">
    </div>
    <h1 class=" text-2xl font-bold text-center col-span-2 mt-10 mb-16">MEDICAL RECORD</h1>
        ...
        <div class="">
            ...
            <div class="grid grid-cols-2 space-x-5 space-y-10 mb-5 place-items-center mt-12">
                <div class="col-span-2 flex space-x-5 justify-items-center items-center ml-5 col-start-1">
                    ...
                    <h1>Patient's name: {{ $patient->name }}</h1>
                </div>
                <div class="flex space-x-5 justify-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                        fill="#000000">
                ...
                <div class="flex space-x-5 justify-items-center col-span-2">
                    ...
                    <h1>Personal address: {{ $patient->address }}</h1>
                </div>
                <div class="flex space-x-5 justify-items-center ">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                        fill="#000000">
                ...
                <div class="col-span-2 flex space-x-5 justify-items-center items-center ml-5 col-start-1">
                    ...
                    <h1>Recent surgery: 08/02/2024</h1>
                </div>
            </div>
