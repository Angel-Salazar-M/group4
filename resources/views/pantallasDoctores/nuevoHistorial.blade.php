        ...
        <div class="">
            ...
            <div class="grid grid-cols-2 space-y-10 mb-5 mt-12 p-6">
                <div class="col-span-2 flex justify-items-center items-center col-start-1 space-x-1 border border-gray-200 bg-gray-100">
                    ...
                    <input type="text" class="border-2 border-cafe w-[50%]">
                </div>
                ...
                <div class="flex justify-items-center space-x-1 bg-gray-100 border border-gray-200">
                    ...
                    <input type="number" class="border-2 border-cafe">
                </div>
                <div class="flex justify-items-center space-x-1 bg-gray-100 border border-gray-200">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                        fill="#000000">
                ...
                <div class="flex justify-items-center space-x-1 bg-gray-100 border border-gray-200">
                    ...
                    <input type="email" class="border-2 border-cafe">
                </div>
                <div class="flex justify-items-center col-span-2 space-x-1 bg-gray-100 border border-gray-200">
                    ...
                    <input type="text" class="border-2 border-cafe col-span-2 w-[70%]">
                </div>
                <div class="flex justify-items-center space-x-1 bg-gray-100 border border-gray-200">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                        fill="#000000">
                    ...
                    <input type="text" class="border-2 border-cafe">
                </div>
                <div class="flex justify-items-center space-x-1 bg-gray-100 border border-gray-200">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                        fill="#000000">
