<div class="w-full mx-auto px-4 sm:px-6 lg:px-8 bg-scriptmorado sticky top-0 z-40 shadow-md">
    <div class="flex justify-between h-16">
        <div class="flex"><a href="/doctor/welcome" class="flex items-center"><img src="{{ asset('img/logoblanco.png') }}" class="w-20 h-6"></a>
            <div class="hidden space-x-2 sm:-my-px sm:ms-10 sm:flex"><!----><!----><!----><!----><!----><a
                    ...
                    <div class="flex items-center"><svg xmlns="http://www.w3.org/2000/svg" height="24px"
                        ...
                        <h1 class="text-white ml-1 font-semibold">Página principal</h1>
                    </div>
                </a></div>
        </div>
        <div class="hidden sm:flex sm:items-center sm:ms-6">
            <div class="flex justify-between space-x-10 h-16"><a
                    ...
                    <div class="flex items-center"><svg xmlns="http://www.w3.org/2000/svg" height="24px"
                        ...
                        <h1 class="text-white ml-1 font-semibold">Pacientes</h1>
                    </div>
                </a><a
                    ...
                    <div class="flex items-center"><svg xmlns="http://www.w3.org/2000/svg" height="24px"
                        ...
                        <h1 class="text-white ml-1 font-semibold">prescripciones</h1>
                    </div>
                </a><a
                    class="inline-flex items-center pt-1 border-b-2 border-transparent text-sm font-normal leading-5 hover:border-gray-700 focus:outline-none focus:text-black transition duration-150 ease-in-out"
                    href="/doctor/profile">
                    <div class="flex items-center"><svg xmlns="http://www.w3.org/2000/svg" height="24px"
                        ...
                        <h1 class="text-white ml-1 font-semibold">Perfil</h1>
                    </div>
                </a></div>
        </div><!---->
