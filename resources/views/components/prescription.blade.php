<x-layout title="Perfil">
    <div class="w-[60%] border-4 border-cafe m-6 p-6 grid grid-rows-2 h-auto grid-rows-[auto_1fr] bg-gray-100">
        ...
        <div class="grid row-start-2 grid-cols-3 p-6">
            <div class="col-start-1 mx-auto"><h1><strong>Patient: </strong>Ángel Gustavo Salazar Mendoza</h1></div>
            <div class="col-start-2 mx-auto"><h1><strong>Date: </strong>07/07/2025</h1></div>
