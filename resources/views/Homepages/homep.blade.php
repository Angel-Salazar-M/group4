        ...
        <div
            ...
            <div class="mx-auto">
                ...
                <div class="flex mb-2 space-x-2 transition-all ease-in-out"><svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <p class="text-[16px] ms-5 text-gray-600">10/08/2024</p>
                </div>
                <div class="flex mb-2 space-x-2 transition-all ease-in-out"><svg xmlns="http://www.w3.org/2000/svg"
                        height="24px" viewBox="0 -960 960 960" width="24px" fill="#000000">
                        <path
            ...
            <div
                ...
                <div class="mx-auto">
                    ...
                    <div class="flex mb-2 space-x-2 transition-all ease-in-out"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <p class="text-[16px] text-black">Enfermedad:</p>
                        <p class="text-gray-600 ms-7"> Fiebre </p>
                    </div>
                    ...
                    <div class="flex mb-2 space-x-2 transition-all ease-in-out"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <p class="text-[16px] text-black">Fecha:</p>
                        <p class="text-[16px] ms-5 text-gray-600">21/07/2024</p>
                    </div>
                    <div class="flex mb-2 space-x-2 transition-all ease-in-out"><svg xmlns="http://www.w3.org/2000/svg"
                            height="24px" viewBox="0 -960 960 960" width="24px" fill="#000000">
                            <path
                ...
                <div
                    ...
                    <div class="mx-auto">
                        ...
                        <div class="flex mb-2 space-x-2 transition-all ease-in-out"><svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <p class="text-[16px] text-black">Enfermedad:</p>
                            <p class="text-gray-600 ms-7"> Nauseas y tos </p>
                        </div>
                        ...
                        <div class="flex mb-2 space-x-2 transition-all ease-in-out"><svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <p class="text-[16px] text-black">Fecha:</p>
                            <p class="text-[16px] ms-5 text-gray-600">12/09/2024</p>
                        </div>
                        <div class="flex mb-2 space-x-2 transition-all ease-in-out"><svg xmlns="http://www.w3.org/2000/svg"
                                height="24px" viewBox="0 -960 960 960" width="24px" fill="#000000">
                                <path
